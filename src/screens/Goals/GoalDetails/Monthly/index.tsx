...
import { deriveSectionedPagesDone, getGoalNumberOfPages, deriveNumberOfPagesDoneMonthly, deriveMonthlyProgress } from '~redux/selectors/goals';
...
const Monthly = () => {
  ...
  const renderSectionHeader = useCallback(
    ({ section }: any) => {
      const isDone = section.count >= goalNumberOfPages;
      return (
            ...
            <View style={{ ...styles.progressBarWrapper, borderColor: progress >= 100 ? colors.gold : colors.completed }}>
              ...
              <View style={styles.progressBarLabelWrapper}>
                <Text style={{ ...styles.progressBarLabel, color: getProgressBarLabelColor() }}>
                  {progress >= 100 ? t('goals:goalAchieved') : `${progress} %`}
                </Text>
              </View>
            </View>
